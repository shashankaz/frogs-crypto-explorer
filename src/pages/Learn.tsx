...
const Learn = () => {
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <Helmet>
        <title>Learn Crypto - Frogs Crypto Explorer</title>
        <meta
          name="description"
          content="Learn the basics of cryptocurrency. Understand Bitcoin, Ethereum, blockchain, and how to navigate crypto markets safely."
        />
      </Helmet>
